      ...
      <header className="bg-white border-b border-gray-200 px-8 py-5">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">Real-time inbound call analytics</p>
          </div>
          {lastUpdated && (
        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
              ...
              />
              <MetricCard
                label="Avg. Negotiated Price"
                value={`$${metrics.avg_negotiated_price.toFixed(0)}`}
              />
              <MetricCard
                label="Agreed Deals"
                value={metrics.outcomes?.agreed || 0}
              />
            </div>
